...
echo_usage() {
echo "Usage:"
echo "  compile-speex.sh armv5|armv7a|arm64|x86|x86_64"
echo "  compile-speex.sh all|all32"
echo "  compile-speex.sh all64"
...
"")
echo_archs armv7a
sh tools/do-compile-speex.sh armv7a
;;
